...
class AccountActivationsRequestsScreen extends StatelessWidget {
  const AccountActivationsRequestsScreen({super.key});
      ...
      body: StreamBuilder(
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return const Center(
              child: Text(
                'No account reactivation requests available',
                style: TextStyle(
                  color: AppColors.color1,
                  fontWeight: FontWeight.bold,
                  fontSize: 30,
