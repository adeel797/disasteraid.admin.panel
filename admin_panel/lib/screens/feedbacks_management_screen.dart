...
class FeedbacksManagementScreen extends StatelessWidget {
  final PostFeedbackService _service = PostFeedbackService();

  FeedbacksManagementScreen({super.key});
          ...
          return GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return CustomCardPostFeedback(
                post: card,
                approve: () async {
                  await _service.approveFeedback(doc.reference);
                },
                reject: () async {
                  await _service.rejectFeedback(doc.reference);
                },
              );
            },
          );
